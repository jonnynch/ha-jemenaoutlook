...
SENSOR_TYPES = {
    ...
    'this_week_percentage_difference': ['This week percentage difference', KILOWATT_HOUR, 'mdi:percent', SensorStateClass.TOTAL_INCREASING],
    # 'this_week_difference_message': ['This week difference message', 'text', 'mdi:clipboard-text'],
    'this_week_consumption_difference': ['This week consumption difference', KILOWATT_HOUR, 'mdi:flash', SensorStateClass.TOTAL_INCREASING],
    'this_week_consumption_change': ['This week consumption change', KILOWATT_HOUR, 'mdi:swap-vertical', SensorStateClass.TOTAL_INCREASING],
    ...
    'this_month_percentage_difference': ['This month percentage difference', KILOWATT_HOUR, 'mdi:percent', SensorStateClass.TOTAL_INCREASING],
    # 'this_month_difference_message': ['This month difference message', 'text', 'mdi:clipboard-text'],
    'this_month_consumption_difference': ['This month consumption difference', KILOWATT_HOUR, 'mdi:flash', SensorStateClass.TOTAL_INCREASING],
    'this_month_consumption_change': ['This month consumption change', KILOWATT_HOUR, 'mdi:swap-vertical', SensorStateClass.TOTAL_INCREASING],
...
class JemenaOutlookSensor(SensorEntity):
